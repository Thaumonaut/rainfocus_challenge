import summit_img from "../images/summit.png";
import person_icon from "../images/person.svg";
    ...
    <section className="attendees">
      ...
      <div className="main-content">
        ...
        <div className="instructions">
          ...
          <p className="step-title">
            <span>Step 2: </span>Build registration workflow
          </p>
          ...
          <p className="step-title">
            <span>Step 3: </span>Design post-registration expereinces.
          </p>
